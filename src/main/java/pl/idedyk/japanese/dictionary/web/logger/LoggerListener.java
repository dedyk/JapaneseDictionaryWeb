...
public class LoggerListener {
	...
	private GenericLogOperationEnum mapClassToGenericLogOperationEnum(Class<?> clazz) {
		...
		} else if (WordDictionary2DetailsLoggerModel.class.isAssignableFrom(clazz) == true) {
			return GenericLogOperationEnum.WORD_DICTIONARY2_DETAILS;
		...
		} else if (BlackListUpdatedLoggerModel.class.isAssignableFrom(clazz) == true) {
			return GenericLogOperationEnum.BLACK_LIST_UPDATED;

...
public class KanjiDictionarySearchLoggerModel extends LoggerModelCommon {
	...
	public KanjiDictionarySearchLoggerModel(String sessionId, String remoteIp, String remoteHost, FindKanjiRequest findKanjiRequest, FindKanjiResult findKanjiResult) {

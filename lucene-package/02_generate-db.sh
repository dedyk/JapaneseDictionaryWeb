...
cp db/kana.csv db/radical.csv db/transitive_intransitive_pairs.csv db/word-power.csv db/word-common.csv db/kanji_recognizer.model.db db/dictionary.pdf $1

...
<c:set var="pageTitle"> <spring:message code="wordDictionaryName.catalog.page.title"/> </c:set>
<c:set var="pageDescription"> <spring:message code="wordDictionaryName.catalog.page.pageDescription"/> </c:set>

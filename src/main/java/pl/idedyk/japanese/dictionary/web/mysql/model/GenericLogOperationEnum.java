...
public enum GenericLogOperationEnum {
	...
	KANJI_DICTIONARY_GET_KANJI_ENTRY_LIST(30),
	KANJI_DICTIONARY_RADICALS(60),
	...
	ANDROID_SEND_MISSING_WORD(90),
	ANDROID_GET_SPELL_CHECKER_SUGGESTION(90),
	ANDROID_QUEUE_EVENT(90),
	ANDROID_GET_MESSAGE(90),
	...
	PAGE_GONE_EXCEPTION(90),
	PAGE_SERVICE_UNAVAILABLE_EXCEPTION(90),
	PAGE_NOT_MODIFIED_EXCEPTION(90),
	SERVICE_UNAVAILABLE_EXCEPTION(90),
	METHOD_NOT_ALLOWED_EXCEPTION(90),
	
	CLIENT_BLOCK(30),
	CLIENT_BLOCK_INFO_ONLY(30),
	CLIENT_RATE_BLOCK(30),

...
public class SitemapLastmodGenerator {

	private static final String DB = "db";

	private static final Logger logger = LogManager.getLogger(SitemapLastmodGenerator.class);
	...
	public static void main(String[] args) throws Exception {
		...
		StringBuffer lastmodMapFileContent = new StringBuffer();
		
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ssZ");
		
		for (Map.Entry<String, Date> currentLastmodEntrySet : lastmodMap.entrySet()) {
			lastmodMapFileContent.append(currentLastmodEntrySet.getKey());
			lastmodMapFileContent.append(",");
			lastmodMapFileContent.append(sdf.format(currentLastmodEntrySet.getValue()));
			lastmodMapFileContent.append("\n");
		}
		
		Files.write(lastmodMapFileContent.toString().getBytes(), new File("db", "lastmod"));

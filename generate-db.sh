...
java -cp $CLASSPATH pl.idedyk.japanese.dictionary.lucene.LuceneDBGenerator db/word.csv db/sentences.csv db/sentences_groups.csv db/kanji.csv db/radical.csv true db-lucene
